For the complete documentation index, see [llms.txt](https://learn.chatgpt.com/llms.txt). Markdown versions of documentation pages are available by appending
`.md` to the page URL.

[![OpenAI Developers](https://learn.chatgpt.com/OpenAI_Developers.svg)ChatGPT](https://learn.chatgpt.com/)

[Home](https://learn.chatgpt.com/)

[API](https://learn.chatgpt.com/api/docs)
...
[ChatGPT](https://learn.chatgpt.com/chatgpt)

[Plugins\\
\\
Extend ChatGPT and Codex](https://learn.chatgpt.com/plugins) [Workspace Agents\\
\\
Trigger published ChatGPT workspace agents](https://learn.chatgpt.com/workspace-agents) [Commerce\\
\\
Build commerce flows in ChatGPT](https://learn.chatgpt.com/commerce) [Ads\\
\\
Publish and measure ads in ChatGPT](https://learn.chatgpt.com/ads)

[Resources](https://learn.chatgpt.com/learn)

[Showcase\\
\\
Demo apps to get inspired](https://developers.openai.com/showcase) [Blog\\
\\
Learnings and experiences from developers](https://learn.chatgpt.com/blog) [Cookbook\\
\\
Notebook examples for building with OpenAI models](https://learn.chatgpt.com/cookbook) [Learn\\
\\
Docs, videos, and demo apps for building with OpenAI](https://learn.chatgpt.com/learn) [Community\\
\\
Programs, meetups, and support for builders](https://learn.chatgpt.com/community)
...
[Overview](https://learn.chatgpt.com/docs) [Features](https://learn.chatgpt.com/docs/features) [Configuration](https://learn.chatgpt.com/docs/configuration) [Developers](https://learn.chatgpt.com/docs/developers) [Security](https://learn.chatgpt.com/docs/security-administration) [Administration](https://learn.chatgpt.com/docs/administration) [Use Cases](https://learn.chatgpt.com/use-cases) [Resources](https://learn.chatgpt.com/resources)
...
OverviewFeaturesConfigurationDevelopersSecurityAdministrationUse CasesResourcesDocs sectionConfiguration

- [Overview](https://learn.chatgpt.com/docs/configuration)

### Customization

- [Overview](https://learn.chatgpt.com/docs/customization/overview)
...
- [Desktop app](https://learn.chatgpt.com/docs/windows/windows-app)
...
- [One-off overrides from the CLI](https://learn.chatgpt.com/docs/config-file/config-advanced#one-off-overrides-from-the-cli)
- [Config and state locations](https://learn.chatgpt.com/docs/config-file/config-advanced#config-and-state-locations)
- [Project config files (.codex/config.toml)](https://learn.chatgpt.com/docs/config-file/config-advanced#project-config-files-codexconfigtoml)
- [Hooks](https://learn.chatgpt.com/docs/config-file/config-advanced#hooks)
- [Agent roles (\[agents\] in config.toml)](https://learn.chatgpt.com/docs/config-file/config-advanced#agent-roles-agents-in-configtoml)
- [Project root detection](https://learn.chatgpt.com/docs/config-file/config-advanced#project-root-detection)
- [Custom model providers](https://learn.chatgpt.com/docs/config-file/config-advanced#custom-model-providers)
- [OSS mode (local providers)](https://learn.chatgpt.com/docs/config-file/config-advanced#oss-mode-local-providers)
- [Azure provider and per-provider tuning](https://learn.chatgpt.com/docs/config-file/config-advanced#azure-provider-and-per-provider-tuning)
- [ChatGPT customers using data residency](https://learn.chatgpt.com/docs/config-file/config-advanced#chatgpt-customers-using-data-residency)
- [Model reasoning, verbosity, and limits](https://learn.chatgpt.com/docs/config-file/config-advanced#model-reasoning-verbosity-and-limits)
- [Approval policies and sandbox modes](https://learn.chatgpt.com/docs/config-file/config-advanced#approval-policies-and-sandbox-modes)
- [Shell environment policy](https://learn.chatgpt.com/docs/config-file/config-advanced#shell-environment-policy)
- [MCP servers](https://learn.chatgpt.com/docs/config-file/config-advanced#mcp-servers)
- [Observability and telemetry](https://learn.chatgpt.com/docs/config-file/config-advanced#observability-and-telemetry)
- [Notifications](https://learn.chatgpt.com/docs/config-file/config-advanced#notifications)
- [History persistence](https://learn.chatgpt.com/docs/config-file/config-advanced#history-persistence)
- [Clickable citations](https://learn.chatgpt.com/docs/config-file/config-advanced#clickable-citations)
- [Project instructions discovery](https://learn.chatgpt.com/docs/config-file/config-advanced#project-instructions-discovery)
- [Desktop](https://learn.chatgpt.com/docs/config-file/config-advanced#desktop)
- [TUI options](https://learn.chatgpt.com/docs/config-file/config-advanced#tui-options)
...
[Previous\\
\\
Config Basics](https://learn.chatgpt.com/docs/config-file/config-basic) [Next\\
\\
Config Reference](https://learn.chatgpt.com/docs/config-file/config-reference)
